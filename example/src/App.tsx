        ...
        <div className="text-center space-y-3">
          <div className="space-y-2">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Mô hình học máy dự đoán nguy cơ mắc bệnh tim
            </p>
          </div>
          ...
          <div>
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 bg-card transition-all duration-300 px-7 py-5 text-lg"
            >
              <a href="https://github.com/cloodei/heart" target="_blank" rel="noopener noreferrer">
